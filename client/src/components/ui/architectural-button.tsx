...
export function ArchitecturalButton({
  ...
  const baseStyles = "relative overflow-hidden transition-all duration-300 group font-sans font-bold tracking-wider uppercase text-sm py-4 px-4 sm:py-6 sm:px-8 rounded-none border-0 whitespace-normal text-center";
